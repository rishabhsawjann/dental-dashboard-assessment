                ...
                {paginated.length === 0 ? (
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="p-4 w-full md:w-auto flex-1 flex flex-col md:table-cell">
                        <span className="block font-semibold text-xs text-gray-500 mb-1 md:hidden">Patient</span>
                      ...
                      <td className="p-4 text-gray-700 w-full md:w-auto flex-1 flex flex-col md:table-cell">
                        <span className="block font-semibold text-xs text-gray-500 mb-1 md:hidden">Age</span>
                        {age} years
                      </td>
                      
                      <td className="p-4 text-gray-700 w-full md:w-auto flex-1 flex flex-col md:table-cell">
                        <span className="block font-semibold text-xs text-gray-500 mb-1 md:hidden">Contact</span>
                        {patient.contact}
                      </td>
                      
                      <td className="p-4 w-full md:w-auto flex-1 flex flex-col md:table-cell">
                        <span className="block font-semibold text-xs text-gray-500 mb-1 md:hidden">Visits</span>
                      ...
                      <td className="p-4 w-full md:w-auto flex-1 flex flex-col md:table-cell">
                        <span className="block font-semibold text-xs text-gray-500 mb-1 md:hidden">Tags</span>
                      ...
                      <td className="p-4 w-full md:w-auto flex-1 flex flex-col md:table-cell">
                        <span className="block font-semibold text-xs text-gray-500 mb-1 md:hidden">Actions</span>
                        <div className="flex gap-2">
                          <button 
                            onClick={() => { setEditPatient(patient); setShowForm(true); }} 
